...
def create_summary_chain(api_key, model_name="gpt-3.5-turbo"):
    ...
    IMPORTANT: According to the document content, create meaningful sub-headers from the document content itself, under which as per the flow of the document structure, mention the pointers in bullet format
    Create as many bullet points as required but make it very detailed capturing and highlighting key information
    Make the bullet points detailed and informative.
